pipeline {
	...
	stages {
		...
		stage('deploy to tomcat from ansible playbook'){
                steps {
						ansiblePlaybook credentialsId: '99233ea5-4303-4b34-b07f-d4c10b55ce6b', inventory: '/etc/ansible/hosts', playbook: '/apps/devops/workspace/Ansible-Deploy-Tomcat/deploy-tomcat-ansible.yml', sudoUser: null
